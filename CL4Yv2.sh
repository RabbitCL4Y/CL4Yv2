...
=================================================
echo $white"Author : MR.CL4Y"
echo $white"Team : Rabbit Cyber Team"
echo $white"Thanks To : MR.X TIKUS BERDASI"
echo $white"thanks To : 2Easy 4Hack Team" 
echo $white"thanks To : Milw0rm Cyber Team"
echo $white"thanks To : Blackhat Hacker 
Indonesia"
echo $white"thanks To : Art Cyber Team "
echo $white"thanks To : Curut Cyber Team "
echo $white"thanks To: Indonesia termux 
association "
